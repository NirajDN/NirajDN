...
<p align="center">
  <a href="https://git.io/streak-stats">
    <img src="https://streak-stats.demolab.com?user=NirajDN&theme=tokyonight" alt="GitHub Streak" />
  </a>
</p>
<!-- <p align="center">
  <img
...
<!--     </td> -->
<!--     <td> -->
<!--       <img src="https://media.licdn.com/dms/image/v2/D4E22AQFECzlsktkisQ/feedshare-shrink_2048_1536/feedshare-shrink_2048_1536/0/1715583200808?e=2147483647&v=beta&t=Cd_yU9bEHjysx2uv9VVvDLRRH8xHgWZBQ8c0qOwq-E0" alt="LeetCode Badge" width="400"> -->
<!--     </td> -->
<!--   </tr> -->
<!-- </table> -->
...
- ["Generative AI"](https://www.carnegiecouncil.org/explore-engage/key-terms/generative-ai?utm_term=&utm_campaign=DSA+-+AI+Pages&utm_source=adwords&utm_medium=ppc&hsa_acc=2829230793&hsa_cam=20628464372&hsa_grp=158166099632&hsa_ad=679476933953&hsa_src=g&hsa_tgt=dsa-2191683515094&hsa_kw=&hsa_mt=&hsa_net=adwords&hsa_ver=3&gad_source=1&gclid=CjwKCAjwyfe4BhAWEiwAkIL8sAnMjUhCXGPnBlj9kFI_D0Eoqq2xvBf0YyLlqRvEkf0RD6NVJDxP6RoCGbEQAvD_BwE)
...
A real-time monitoring system that logs and visualizes OS-level security events to help detect potential vulnerabilities. It features a dynamic dashboard with WebSocket integration, enabling seamless live updates from the backend. Built with React on the frontend and Node.js/Express on the backend, it uses MongoDB for efficient event storage and retrieval. The system tracks security events in real time, providing insights into system activity for proactive monitoring and analysis.

- [🔗 Time-Explorer)](https://github.com/NirajDN/Time-Explorer)-🕰️ Time Explorer – Historical Events Finder
Time Explorer is an interactive web app that lets users discover major historical events from any selected date. If no significant event is found, it seamlessly displays top news headlines from that date, offering both history and real-world context.
...
---
Current Date and Time (UTC - YYYY-MM-DD HH:MM:SS formatted): 2026-01-10 07:06:58
Current User's Login: NirajDN
